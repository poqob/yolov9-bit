\begin{table}[htbp]
\centering
\caption{YOLOv9 Eğitilmiş Model Karşılaştırma Tablosu}
\label{tab:model-comparison}
\resizebox{\textwidth}{!}{
\begin{tabular}{lllrrrrrrrrrr}
\toprule
Model Mimarisi & Aktivasyon & Optimizasyon & Boyut (MB) & mAP@0.5 & mAP@0.5:0.95 & Kesinlik & Hassasiyet & En İyi Epok & Toplam Epok & Box Loss & Cls Loss & DFL Loss \\
\midrule
